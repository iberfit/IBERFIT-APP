...
function collectCriterion() {
  ...
  return {
    ...
    draft: { blocks, estructuraTipo:'V11-F7.7-CONSTRUCTOR-BLOQUES-TEMPORIZADORES' }
  };
}
...
async function saveDraft() {
  ...
  const draft = { ...(state.currentDraft || {}), blocks: arr(state.currentDraft?.blocks).length ? state.currentDraft.blocks : criterion.sessionBlocks, estructuraTipo:'V11-F7.7-CONSTRUCTOR-BLOQUES-TEMPORIZADORES' };
...
function renderQa() {
  shell(`<section class="hero-card"><p>CONTROL DEL SISTEMA</p><h1>Centro de verificación V11-F7.7</h1><span>Validar sistema completo antes de despliegue: autenticación, Sheets, publicación, informes, IRI, bioimpedancia, sesiones, PWA y Gemini opcional.</span></section><section class="module-grid"><article class="app-card"><h2>Pruebas</h2><div class="action-row"><button class="btn btn-primary" id="qaCentroVerificacion">Centro de verificación</button><button class="btn btn-primary" id="qaGet">Conexión API</button><button class="btn btn-primary" id="qaPost">Salud del servidor</button><button class="btn btn-primary" id="qaAudit">Auditoría V11</button><button class="btn btn-primary" id="qaHealth">Panel de salud del sistema</button><button class="btn btn-primary" id="qaDecision">Resumen de decisión</button><button class="btn btn-primary" id="qaSemantic">Biblioteca semántica</button><button class="btn btn-primary" id="qaBio">Informes de bioimpedancia</button><button class="btn btn-primary" id="qaLive">Sesión presencial</button><button class="btn btn-primary" id="qaSearch">Buscar ejercicios</button><button class="btn btn-primary" id="qaPostAnalysis">Análisis post-sesión</button><button class="btn btn-primary" id="qaSmartReport">Informe inteligente</button><button class="btn btn-primary" id="qaLearning">Aprendizaje supervisado</button><button class="btn btn-primary" id="qaMedia">Multimedia</button><button class="btn btn-primary" id="qaClientExp">Experiencia cliente</button><button class="btn btn-primary" id="qaPremiumExp">Experiencia premium</button><button class="btn btn-primary" id="qaExternalActivity">Actividad externa</button><button class="btn btn-primary" id="qaWearablesGuide">Guía de integraciones</button></div><div id="qaStatus"></div></article><article class="app-card"><h2>Criterios de aprobación V11-F7.7</h2><ul><li>Contrato de headers OK en Clientes, Sesiones, Feedback y Check-in.</li><li>Sin IDs duplicados ni sesiones huérfanas.</li><li>Estados de sesión válidos.</li><li>La validación previa bloquea publicaciones incoherentes.</li><li>Gemini queda como apoyo opcional, nunca fuente de verdad.</li><li>V11-F7.7 mantiene decisión explicable y refuerza marca IBERFIT, isotipo, experiencia guiada y pulido visual final.</li><li>Sesión presencial puede iniciar, registrar series, actualizar cargas/histórico y cerrar.</li><li>Biblioteca semántica disponible o declarada como parcial antes de automatizar cargas.</li></ul></article></section><section class="app-card"><h2>Validación previa de publicación</h2><div class="form-grid"><div class="field"><label>Identificador de sesión</label><input id="qaSessionId" placeholder="SES-APPCLI-0001-XXXX"></div><div class="field"><label>Acción</label><button class="btn btn-outline" id="qaPreflight">Ejecutar validación previa</button></div></div></section><section class="app-card"><h2>Resultado</h2><div id="qaOutput" class="muted">Pendiente.</div></section>`, { active: 'qa', title: 'Control del sistema' });
