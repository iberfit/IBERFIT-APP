...
const BASE_REPORTS = [
  { id: "INF-MOCK-IRI", date: "2026-06-25", type: "IRI", title: "Informe IRI inicial", state: "PUBLICADO", clientVisible: "Sí", clientVersion: "Punto de partida evaluado. El plan prioriza técnica, progresión prudente y seguimiento.", url: "" },
  { id: "INF-MOCK-PROG", date: "2026-06-27", type: "Progreso", title: "Lectura de progreso", state: "PUBLICADO", clientVisible: "Sí", clientVersion: "Respuesta estable. Mantener adherencia y registrar feedback para ajustar cargas.", url: "" }
];
...
export const mockDataPresencial = {
  ...
  week: {
    ...
    sessions: [
      { ...BASE_SESSION_LOWER, deliveryMode: "PRESENCIAL", type: "Fuerza", title: "Sesión presencial · Fuerza tren inferior" }
    ]
  },
  iri: { total: "68", classification: "PERFORMANCE", recommendation: "Consolidar fuerza técnica y progresar carga de forma controlada.", context: "Cliente presencial con buena adherencia.", bioimpedance: "Bioimpedancia compatible con foco en composición corporal.", composition: "Objetivo: mejorar masa muscular y reducir grasa progresivamente.", mobility: "Movilidad funcional suficiente, monitorizar cadera y tobillo.", strength: "Fuerza base en progresión.", metabolic: "Capacidad aeróbica base estable.", limiters: "Técnica en sentadilla y recuperación entre sesiones.", decision: "Progresar carga si RPE y técnica se mantienen." },
  process: {
...
export const mockDataHibrido = {
  ...
  week: {
    ...
    sessions: [
      { ...BASE_SESSION_LOWER, deliveryMode: "PRESENCIAL", type: "Fuerza", title: "Sesión presencial · Fuerza tren inferior" },
      { ...BASE_SESSION_MOVILIDAD, deliveryMode: "AUTONOMA", type: "Movilidad", title: "Trabajo autónomo · Movilidad + Zona 2" }
    ]
  },
  iri: { total: "62", classification: "PERFORMANCE", recommendation: "Construir base técnica antes de aumentar carga.", context: "Inicio híbrido con foco en adherencia y técnica.", bioimpedance: "Registro inicial disponible para seguimiento de composición.", composition: "Prioridad: recomposición con control de carga.", mobility: "Limitación leve de movilidad de cadera.", strength: "Base suficiente para progresión conservadora.", metabolic: "Capacidad metabólica en construcción.", limiters: "Movilidad de cadera, tolerancia de volumen y constancia semanal.", decision: "Mantener semana base y progresar si feedback confirma buena recuperación." },
  process: {
...
export const mockDataOnline = {
  ...
  week: {
    ...
    sessions: [
      { ...BASE_SESSION_LOWER, id: "SES-ONL-001", deliveryMode: "ONLINE", type: "Fuerza", title: "Día 1 · Fuerza tren inferior" },
      { ...BASE_SESSION_MOVILIDAD, id: "SES-ONL-002", deliveryMode: "ONLINE", type: "Movilidad", title: "Día 2 · Recuperación activa" },
      {
        id: "SES-ONL-003",
  ...
  iri: { total: "55", classification: "BASE", recommendation: "Priorizar adherencia, técnica y tolerancia de volumen antes de intensificar.", context: "Cliente online con necesidad de autonomía guiada.", bioimpedance: "Pendiente de nueva medición o registro externo.", composition: "Objetivo de composición con seguimiento mensual.", mobility: "Movilidad suficiente para sesiones base.", strength: "Fuerza inicial moderada.", metabolic: "Base aeróbica mejorable.", limiters: "Autogestión, técnica sin supervisión presencial y recuperación.", decision: "Mantener feedback obligatorio en cada sesión." },
  process: {
